...
```text
รับค่าเป็นหน่วยอุณหภูมิ 2 ค่าโดยแรกเป็นค่าต้นสองเป็ค่าที่แปลงจากคค่าแรก
output เป็น ค่าที่ถูกแปลงออกมาแล้ว โดยเป็นเลขทศนิยมสองตัว
```
...
```text
Step 1:รับค่าเลข
Step 2:รับค่าหน่วยที่จะแปลงจ่าก
Step 3:รับค่าหน่วยที่จะแปลงไปเป็น
Step 4:ลอจิกที่ครอบครุมระหว่างค่าที่สามารถแปลงจากหน่วยไปเป็นอีกหน่วย
Step 5:แสดงค่าพร้อมทศนิยมสองตัว
```
...
```text
ใช้แบบแผนที่คล้ายกับแผนแรก แต่เพื่มลอจิกที่เพื่มการตรวจหากผู้ใช้แปลงค่าไปเป็นค่าเดิมเพื่อกัน error
```
...
```text
ตรวจสอบว่าลอจิกการแปลงทำงานได้
```
...
```text
ตรวจสอบการแปลงค่ากลับ ค่อจาก testcase แรก
```
...
```text
ตรวจลอจิกการแปลงไปเป็นหน่วยเดิม
```
