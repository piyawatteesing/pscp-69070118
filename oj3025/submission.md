...
```text
โจทย์ต้องการค่า input เป็นตัวเลข 'month' และ 'day' ซึ่งแยกกัน output จะมี winter spring summer และ fall ขึ้นอยุ่กับลอจิกกับที่โจทย์ต้องการ โดยเลื่อน output ใน 4 ตัวนี้ไปเป็นตัวถัดไปหาก day คือ 21 หรือมากกว่า หากเลขที่เดือนนั้นๆหาร 3 ลงตัว
```
...
Step 1:input month
Step 2:input day
Step 3:if month in (1 to 3) 
step 4:   if month == 3 and day >= 21 #เดือนที่ 3 หารกับ 3 ลงตัวและวันที่ 21 หรือมากวว่า เป็นจริง เลือนจาก winter เป็น spring
step 5:      print("spring")
step 6:else print("winter") #หากไม่ไช่วันที่ 21 หรือมากกว่า output จะเป็นไปตามที่โจทย์ต้องการ
```
...
```text
**ใด้ใช้แผนเดิมกับที่เขียนใว้ในตอนเแรก*
ตัวโค้ดนั้นเขียนตามความเข้าใจล้วนๆ และเป็นโค้ดที่ยังสามารถอธิบายได้ ถึงแม้จะมี nested if อยุ่พอสมควร
```
...
```text
ทดสอบว่าลอจิกแบบปกติทำงานได้ไหม
```
...
```text
ทดสอบว่าลอจิกแบบปกติทำงานได้ไหมโดยใช้เดือนที่หารด้วยสามลงตัว
```
...
```text
ทดสอบว่าลอจิกแบบปกติทำงานได้ไหมโดยใช้ตัวเลขที่ไม่อยุ่ในเงื่อนใข
```
