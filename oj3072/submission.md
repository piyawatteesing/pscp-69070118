...
```text
รับtextยาว (ไม่่มี space) การแสดงผลขึ้นอยุ่กับจำนวน a,e,i,o,u ในtext ที่รับมา
```
...
```text
Step 1:รับค่าtext
Step 2:วนด้วย for loop แปลงความยาว textเป็นคัวเลขและเอาไปรันใน range 
Step 3:เช็คว่าแต่ละอักษรเข้าเงื่อนไขไหม (เป็น a e i o u หรือไม่) หาเข้าจะในไปบวกเก็บใว้ในแต่ละตัวแปรที่แยกกัน
```
...
```text
ใช้แผนเดียวกับแผนแรกเนื่องจากใช้ได้ผล,เป็นสิ่งที่ทำถนัด ซึ่งอาจต้องเขียนยาวไปหน่อยก็ตาม
```
...
```text
ตรวจสอบลอจิกที่ไม่เข้าเงื่อนไข
```
