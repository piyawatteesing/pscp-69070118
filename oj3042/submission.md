...
```text
รับค่าตัวเลขใน a แสดงออกมาเป็นตัวเลขที่น้อยกว่าและแสดงเฉพาะเลขที่หารลงตัวกับ 10 ออกมาจนถึง 0
```
...
```text
Step 1:รับค่า n
Step 2:นำค่าไปใส่ใน for loop ซึ่งขึ้นอยุ่กับจำนวนที่รับมา 
Step 3:เอาค่า n ไปรันใน range เร่มที่ num จบก่อน -1 (0) และลดทีละ -1 
```
...
```text
ใช้แบบเดียวกับที่ใช้ในแผนแรก เนื่องจากใช้ได้ผลและสั้น
```
...
```text
ทดสอบลอจิกที่ตรวจสอบการหารลงตัวพร้อมการลดค่า
```
