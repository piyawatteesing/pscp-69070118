...
```text
รับค่าเป็น string สองตัวแปรในบรรทัดแรก และ น้ำหนักในบรรทัดที่สอง
แสดงผลออกมาเป็นราคาที่ต้องจ่ายขึ้นอยุ่กับน้ำหนักและระยะทางที่เลือก
```
...
```text
Step 1:รับค่าเป็น string สองตัวแปรแยกกัน
Step 2:รับค่าน้ำหนัก
Step 3:ลอจิกซึ่งแปลงค่าน้ำหนักและระยะทาง(จังหวัด)ออกเป็นราคา
```
...
```text
ใช้แผนเเดิมเนื่องจากโจทย์ไม่ได้มีความซับซ้อนอะไรมากและตรงไปตรงมา ซึ่งโจทย์ได้ให้ตารางระยะทางมาทำให้ออกแบบลอจิกได้เร็ว
```
...
```text
ทดสอบลอจิกที่ไม่เข้าเงื่อนไข (เข้าเงื่อนไข error)
```
