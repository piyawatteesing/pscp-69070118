...
```text
รับค่าเป็นสถานะ จำนวนสินค้า ราคาสินค้า และจำนวนที่รับราคาสินค้าขึ้นอยุ่กับจำนวนสินค้า
outputเป็นราคาที่ทำการคำนวนออกมาแล้ว 
```
...
```text
Step 1:รับค่า status
Step 2:รัยค่าจำนวนสินค้า
Step 3:รับค่าราคาสินค้า (รับกี่คร้้งก็ขึ้นอยุ่กับค่าจำนวนที่รับมา)
Step 4:รวมราคาทั้งหมด และนำไปเข้าลอจิก
Step 5:เป็นสถานะนักเรียน ลดราคา 5% หลังรวม หากไม่เป็นนักเรียน แต่รวมราคาได้ 500 หรือมากกว่า จะลดราคา 3% หากนอกเหนือ จะไม่ลดราคา
Step 6:ปัดทศนิยมหลักที่ 2
Step 7:แสดงผลราคาที่คำนวนแล้ว
```
...
```text
ใช้แผนเดิมเนื่อจากถนัดและเข้าใจง่ายที่สุดแล้ว
```
